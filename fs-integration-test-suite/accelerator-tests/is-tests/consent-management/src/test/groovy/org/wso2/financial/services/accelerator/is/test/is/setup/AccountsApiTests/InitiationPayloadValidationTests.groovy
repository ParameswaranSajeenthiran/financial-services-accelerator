...
package org.wso2.financial.services.accelerator.is.test.is.setup.AccountsApiTests
...
class InitiationPayloadValidationTests extends FSConnectorTest {
    ...
    @Test
    void "Accounts Initiation With empty Permissions"() {

        setInitiationPayload(AccountsRequestPayloads.getUpdatedInitiationPayload([]))
        doDefaultInitiation()
