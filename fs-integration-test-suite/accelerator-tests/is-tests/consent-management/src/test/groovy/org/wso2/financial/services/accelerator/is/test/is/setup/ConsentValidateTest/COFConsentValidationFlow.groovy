...
package org.wso2.financial.services.accelerator.is.test.is.setup.ConsentValidateTest
...
/**
 * COF Consent Validation Tests.
 */
class COFConsentValidationFlow extends FSConnectorTest {
    ...
    void "Verify Validation of a created Consent without Content Type Header"() {
        ...
        consentValidateResponse = FSRestAsRequestBuilder.buildRequest()
                ...
                .baseUri(configuration.getISServerUrl())
                .post(ConnectorTestConstants.COF_VALIDATE_PATH)
    ...
    void "Verify Validation of a created Consent with mismatching client Id"() {
        ...
        //Consent Validate Request
        validationPayload = CofRequestPayloads.buildCofValidationPayload(accessToken, userId, consentId, "clientId")
